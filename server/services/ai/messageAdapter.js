...
export function normalizeSettings(raw = {}) {
  ...
  return {
    ...
    responseTone: ["auto", "professional", "friendly", "direct"].includes(raw.responseTone)
      ? raw.responseTone
      : "auto",
    preferredTerminal: ["auto", "powershell", "macos", "bash"].includes(raw.preferredTerminal)
      ? raw.preferredTerminal
      : "auto",
    preferCompleteCode: raw.preferCompleteCode !== false,
  };
}
