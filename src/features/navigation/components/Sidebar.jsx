    ...
    <>
      <aside className={`sidebar ${app.sidebarOpen ? "open" : "closed"}`}>
        ...
        <div className="side-section">
          ...
          {app.pinnedHistory.length > 0 && (
            <>
              <div className="history-group-label">Pinned</div>
              {app.pinnedHistory.map((item) => (
                <HistoryRow key={item.id} app={app} item={item} />
              ))}
            </>
          )}

          {app.pinnedHistory.length > 0 && app.recentHistory.length > 0 && (
            <div className="history-group-label history-group-recent">Recent</div>
          )}

          {app.recentHistory.map((item) => (
            <HistoryRow key={item.id} app={app} item={item} />
          ))}
        </div>
