      ...
      <div className="voice-panel">
        ...
        <div className="voice-center">
          ...
          <div className="voice-status">
            ...
            <p>{
              app.settings.voiceShowTranscript !== false && app.input
                ? app.input
                : app.speechSupported
                  ? (app.settings.voiceShowTranscript === false ? "Listening transcript is hidden." : "Speak naturally.")
        ...
        <div className="voice-controls">
          <div className="voice-control-actions">
            ...
            {app.settings.voiceAutoSend === false && app.input?.trim() && !app.listening && !app.streaming && (
              <button className="voice-send-transcript" type="button" onClick={() => app.submitMessage(app.input.trim())}>
                Send transcript
              </button>
            )}
          </div>
